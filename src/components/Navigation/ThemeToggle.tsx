...
export default function ThemeToggle() {
    ...
    return (
        <>
            <div className="flex bg-custom-light dark:bg-bg-dark relative items-center shadow-(--box-shadow-custom-1) justify-between rounded-full w-22.5 h-11.5" onClick={() => handleClick()}>
