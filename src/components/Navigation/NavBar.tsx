...
export default function NavBar() {
    ...
    return (
        <div className={`fixed w-full left-0 ${isScrolled ? 'pt-0' : 'pt-5'} ${isScrolled && 'bg-bg dark:bg-bg-dark shadow-lg shadow-black/50 transition-shadow transition-padding duration-600'}`}>
