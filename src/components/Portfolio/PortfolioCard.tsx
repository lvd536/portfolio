...
export default function PortfolioCard({header, dateTime, dateString, description, skills, projectImage}: {
    ...
    return (
        <div className="flex bg-custom-light dark:bg-bg-dark gap-[10vw] mt-10 transition-shadow duration-300 shadow-(--box-shadow-custom-2) hover:shadow-(--box-shadow-custom-hover) rounded-xl p-10 animate-custom-bounceY">
